...
NEURON {
	...
	RANGE fmax, fmin, Wmax, Wmin, maxChange, normW, scaleW, limitW
...
PARAMETER {
	...
	initW = 1.11 : 2.5/2.25 : 5.5 : 5 : 4 : 3 : 4 : 8

	lambda1 = 40 : 60 : 70: 20 : 15
	lambda2 = .04 : .0 : 0.03
	threshold1 =0.3 : 0.40 : 0.35 : 0.45 : 0.5 : 0.3 (uM)
	threshold2 =0.4 : 0.53 : 0.55 : 0.60 : 0.55 : 0.55 : 0.6 : 0.4 : 0.45 (uM)
...
BREAKPOINT {
	...
	: }
	if (neuroM>=2) {
	g_nmda = gbar_nmda*r_nmda*NEn(NEstart1,NEstop1)*NE2(NEstart2,NEstop2)       : Dopamine effect on NMDA to reduce NMDA current amplitude
		} else {
